...
const Footer: React.FC = () => {
  ...
  const handleNewsletterSubmit = async (e: React.FormEvent) => {
    ...
    const invalidMsg =
      (t.invalidEmail as string) || "Please enter a valid email address.";
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 pt-2">
              <a
                href="https://github.com/Naman-iitm/sehat-saathi-guide"
                target="_blank"
                rel="noopener noreferrer"
                title="Github page coming soon"
                className="text-muted-foreground hover:text-primary transition-colors"
              >
                <Github className="w-5 h-5" />
              </a>
              <a
                href="mailto:itsnaman0007@gmail.com"
                target="_blank"
                rel="noopener noreferrer"
                title="Email page coming soon"
                className="text-muted-foreground hover:text-primary transition-colors"
              >
                <Mail className="w-5 h-5" />
              </a>
              <a
                href="https://www.instagram.com/smi_naman/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.linkedin.com/in/naman-iitm/"
                target="_blank"
                rel="noopener noreferrer"
